...
import API_BASE_URL from "../config/api"; // 🔥 IMPORTAR
...
export default function Catalogo() {
  ...
  const cargarProductos = async () => {
    try {
      // Agregamos /api para que coincida perfectamente con tus rutas del backend
  ...
  const renderItem = ({ item: p }) => (
    <View style={styles.cardGlaze}>
      <View style={styles.imageWrapper}>
        ...
        {/* Imagen directa de Cloudinary guardada en p.imagen */}
        <Image
          source={{ uri: p.imagen }}
